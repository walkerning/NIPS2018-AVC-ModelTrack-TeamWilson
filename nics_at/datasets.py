...
class Dataset(object):
    def __init__(self, batch_size, epochs, aug_saltpepper, aug_gaussian, generated_adv=[], num_threads=2, capacity=1024):
    ...
    def read_image(self, filename_q, mode):
        ...
        if mode == "train":
            ...
            if self.aug_gaussian is not None:
    ...
    def batch_q(self, mode):
        ...
        return tf.train.batch_join([self.read_image(filename_q, mode) for i in range(self.num_threads)],

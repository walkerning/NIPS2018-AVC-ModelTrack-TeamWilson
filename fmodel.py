...
class EnsembleModel(DifferentiableModel):
    ...
    def __init__(self, models, cfgs, ensemble_type="weight", multi_angle=[], use_resolution=[], multi_type="mean", bounds=(0, 255), channel_axis=3, preprocessing=(0, 1)):
    ...
    def batch_predictions(self, images):
        ...
        elif self.multi_angle is not None:
